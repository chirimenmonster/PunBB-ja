...
'E-mail address help'		=>	'フォーラム管理者のE-mail',
'Part3'						=>	'Part 3 - フォーラム初期設定',
'Part3 legend'				=>	'フォーラム情報',
'Part3 intro'				=>	'必要な情報を入力してください。特にベースURLの入力には注意書きを読んで気をつけて入力してください。',
'Board title'				=>	'掲示板タイトル',
'Board title and desc'		=>	'掲示板のタイトルと説明',
'Board description'			=>	'掲示板の説明',
'Base URL'					=>	'ベースURL',
'Board title info'			=>	'インストールするPunBBの掲示板タイトルと説明を入力してください。これらはすべてのページに表示されるものです。空欄の場合はデフォルトのものが使用されます。いずれも後から変更できます。',
...
'Required'					=>	'(必須)',
'Required warn'				=>	'%s と表示された項目は入力が必要です。',
...
'Pass not match'			=>	'パスワードが一致しません。前画面へ戻って修正してください。',
...
'Invalid email'				=>	'管理者e-mailアドレスが正しくありません。前画面へ戻って修正してください。',
...
'Success welcome'			=>	'次の指示に従って、インストールを完了してください。',
