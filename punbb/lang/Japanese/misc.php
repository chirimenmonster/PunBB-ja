...
// Hostname lookup
'Hostname lookup'			=>	'IPアドレス: %1$s<br />ホスト名: %2$s<br /><br />%3$s',
'Show more users'			=>	'このIPのユーザーをさらに表示',

// Moderate forum
'Moderate forum head'		=>	'モデレート: %s',
'Topics'					=>	'トピック',
'Move topic'				=>	'トピックを移動',
'Move topics'				=>	'トピックを移動',
'Merge topics'				=>	'トピックを結合',
'Delete topics'				=>	'トピックを削除',
...
// Moderate topic
'Posts'						=>	'投稿',
'Delete posts'				=>	'選択した投稿を削除',
'Split posts'				=>	'選択した投稿を分割',
'Delete whole topic'		=>	'すべての投稿を削除',
'Moderate topic head'		=>	'トピックをモデレート: %s',
'New subject'				=>	'新トピックのタイトル:',
'Select post'				=>	'投稿の選択', // Label for checkbox
'Confirm post delete'		=>	'選択した投稿すべての削除することを確認',
'Confirm topic delete'		=>	'選択した全てのトピックの削除することを確認',
