...
'New posts'					=>	'新規の投稿',	// the link that leads to the first new post
'New posts title'			=>	'最後に訪問したあとに投稿のあったトピックを表示します。',	// the popup text for new posts links
'Active topics'				=>	'活発なトピック',
'Active topics title'		=>	'最近の投稿があるトピックを表示します。',
'Unanswered topics'			=>	'返信のないトピック',
'Unanswered topics title'	=>	'返信のないトピックを表示します。',
'Username'					=>	'ユーザー名',
'Registered'				=>	'登録済',
